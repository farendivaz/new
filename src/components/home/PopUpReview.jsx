                    ...
                    <div
                        ...
                        <div className="flex items-center justify-between w-full gap-1 mx-auto">
                            <div className="flex items-center justify-end w-[90%] mx-auto">
                                <img className="w-1/4 my-4 ml-4 rounded-full md:w-1/6 md:ml-8" src="https://demo.fitaja.id//storage/testimonies/HErLgTk8r1dQltFPCjxeAMgHCzS3AL7RZxx7X84v.jpg" alt="PERSON" />
